...
const [errorMessage, setErrorMessage] = useState("You have suckskla kljkl jklaj")
                ...
                <p className="general-form-title">Login</p>
                    <form id="loginForm" onChange={handleChange} onSubmit={e => handleSubmit(e)}>
                        ...
                        <div className="auth-form-line fx-basic fx-justify-between fx-align-center">
                                ...
                                <input className="right-input" type="email" id="login-email" placeholder="Email" autoComplete={"email"}></input>
                            </div>

                            <div className="auth-form-line fx-basic fx-justify-between fx-align-center">
                                <label className="left-input" htmlFor="login-password">Password</label>
                                <input className="right-input" type="password" id="login-password" placeholder="Password" autoComplete={"password"}></input>
                            </div>
                            <div className={`fx-basic fx-justify-center fx-align-center ${!error && !success ? "visibility-none auth-message" : error ? "auth-message auth-error" : "auth-message auth-success"}`}>{error ? <span>{errorMessage}</span> : success ? <span>{successMessage}</span> :"Filler text"}</div>
